...
- 의존성 주입을 생성자 주입으로 변경 예정(JavaBean 규칙에 맞게 변경 포함 blog: <a href="https://madplay.github.io/post/why-constructor-injection-is-better-than-field-injection">생성자 주입</a><br><a href="https://imasoftwareengineer.tistory.com/101">JavaBean</a>)
